// Use the WASM implementation for better compatibility
// TODO: Switch to native implementation when darwin-aarch64 is supported
// See: https://github.com/b-fuze/deno-dom/issues/144
import { DOMParser, type Element as DOMElement, type Node } from "jsr:@b-fuze/deno-dom@0.1.49";
 ...
 */
function processHTML(dom: DOMElement): string {
  let output = "";
